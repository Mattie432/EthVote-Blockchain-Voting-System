	...
	\noindent  	
  	\makebox[\textwidth]{
  	    \begin{tabular}{ | l | S |}
			...
			Average cost to fully deploy a ballot & \\ (initial deployment, option addition \& finalization). & 0.96 \\ \hline
...
\end{figure}
	...
	\begin{figure}[h]
		\noindent
  		\makebox[\textwidth]{\includegraphics[width=1.08\textwidth]{cost_voter_addition}}%
		\vspace*{-0.3cm}
